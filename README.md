...
This repository contains a Karpathy-style LLM Wiki: compact, interlinked markdown notes that compound over time.
...
- `index.md` is the main entry point.
- `SCHEMA.md` defines wiki conventions.
- `log.md` tracks maintenance and review history.
- `concepts/`, `entities/`, `comparisons/`, and `raw/` contain domain content.
